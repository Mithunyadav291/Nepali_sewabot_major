...
//     // await initializeDB(); // create SQLite table
//     router.push(user ? "/(tabs)" : "/(auth)");
//   };

//   return (
//     <SafeAreaView
//       //   colors={[COLORS.backgroundFirst, COLORS.backgroundSecond]}
...
//             <Text className="text-2xl font-bold text-center  color-gray-800">
//               {item.title}
//             </Text>
//             <Text className="text-l font-semibold text-center  color-gray-400">
//               {item.subtitle}
//             </Text>
